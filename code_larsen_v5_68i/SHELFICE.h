...
CEOP
     ...
     &   shelfIceMassDynTendency(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      ...
      _RL shelfice_fricvel      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL shelfice_uloc         (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL shelfice_vloc         (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
